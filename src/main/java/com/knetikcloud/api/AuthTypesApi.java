...
public interface AuthTypesApi {
   ...
   * @return Call&lt;PageResourceAccessResultsResource&gt;
   */
  @GET("access/resources/{type}/{id}/actions")
  Call<PageResourceAccessResultsResource> allowedResourceActions(
    @retrofit2.http.Path("type") String type, @retrofit2.http.Path("id") String id, @retrofit2.http.Query("size") Integer size, @retrofit2.http.Query("page") Integer page
  );
  ...
  Call<PageResourceAccessResultsResource> allowedTypeActions(
